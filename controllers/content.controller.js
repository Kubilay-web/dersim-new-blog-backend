...
export const getContentByIdAndLanguage = async (req, res) => {
  const { contentId, language } = req.params; // URL parametrelerinden contentId ve language alınır

  try {
    // Hem contentId hem de language parametrelerine göre içerik araması yap
